...
-- 2020-11-02
L.lang_server_default = "Server Predefinito"
--L.help_lang_info = [[
...
-- 2021-04-13
L.title_score_info = "Info Fine Round"
L.title_score_events = "Sequenza temporale di Eventi"

L.label_bind_clscore = "Apri la schermata"
L.title_player_score = "Score del {player}"

L.label_show_events = "Mostra eventi da:"
L.button_show_events_you = "Tu"
L.button_show_events_global = "Globale"
L.label_show_roles = "Mostra la distribuzione dei ruoli da"
L.button_show_roles_begin = "Inizio round"
L.button_show_roles_end = "Fine Round"

L.hilite_win_traitors = "TEAM TRADITORI HA VINTO"
L.hilite_win_innocents = "TEAM INNOCENTI HA VINTO"
L.hilite_win_tie = "PAREGGIO"
L.hilite_win_time = "IL TEMPO È SCADUTO"

L.tooltip_karma_gained = "Karma guadagnato questo round:"
L.tooltip_score_gained = "Punteggio guadagnato questo this round:"
L.tooltip_roles_time = "Ruoli nel tempo:"

L.tooltip_finish_score_alive_teammates = "Alleati vivi: {score}"
L.tooltip_finish_score_alive_all = "Giocatori vivi: {score}"
L.tooltip_finish_score_timelimit = "IL TEMPO È SCADUTO: {score}"
L.tooltip_finish_score_dead_enemies = "Nemici morti: {score}"
L.tooltip_kill_score = "Uccisioni: {score}"
L.tooltip_bodyfound_score = "Corpi trovati: {score}"

L.finish_score_alive_teammates = "Alleati vivi:"
L.finish_score_alive_all = "Giocatori Vivi:"
L.finish_score_timelimit = "Time is up:"
L.finish_score_dead_enemies = "Nemici Morti:"
L.kill_score = "Uccisioni:"
L.bodyfound_score = "Corpi Trovati:"

L.title_event_bodyfound = "Un corpo è stato trovato"
L.title_event_c4_disarm = "Una carica C4 è stata disarmata"
L.title_event_c4_explode = "Una carica C4 è esplosa"
L.title_event_c4_plant = "Una carica C4 è stata piantata"
L.title_event_creditfound = "Crediti equipaggiamento trovati"
L.title_event_finish = "Il round è terminato"
L.title_event_game = "Un nuovo round è iniziato"
L.title_event_kill = "Un giocatore è stato ucciso"
L.title_event_respawn = "Un giocatore è rinato"
L.title_event_rolechange = "Un giocatore ha cambiato il ruolo o il Team"
L.title_event_selected = "I ruoli sono stati selezionati"
L.title_event_spawn = "Un giocatore è stato schierato"

L.desc_event_bodyfound = "{finder} ({firole} / {fiteam}) ha trovato il corpo di {found} ({forole} / {foteam}). il cadavere contiene {credits} crediti di equipaggiamento."
L.desc_event_bodyfound_headshot = "Il giocatore morto è stato ucciso da un colpo in testa."
L.desc_event_c4_disarm_success = "{disarmer} ({drole} / {dteam}) ha correttamente disarmato la carica C4 pizzata da {owner} ({orole} / {oteam})."
L.desc_event_c4_disarm_failed = "{disarmer} ({drole} / {dteam}) ha provato a disarmare la carica C4 piazzata da {owner} ({orole} / {oteam}). Ha fallito."
L.desc_event_c4_explode = "La C4 piazzata dal giocatore {owner} ({role} / {team}) è esplosa."
L.desc_event_c4_plant = "{owner} ({role} / {team}) ha piazzato una carica C4."
L.desc_event_creditfound = "{finder} ({firole} / {fiteam}) ha trovato {credits} crediti equipaggiamento nel corpo di {found} ({forole} / {foteam})."
L.desc_event_finish = "il round è  durato {minutes}:{seconds}. C'erano {alive} Giocatori vivi in questa partita."
L.desc_event_game = "Un nuovo round è iniziato."
L.desc_event_respawn = "{player} è rinato."
L.desc_event_rolechange = "{player} ha cambiato il suo team/ruolo da {orole} ({oteam}) a {nrole} ({nteam})."
L.desc_event_selected = "I team e i ruoli sono stati selezionati per tutti i {amount} Giocatori."
L.desc_event_spawn = "{player} è stato schierato."

-- Name of a trap that killed us that has not been named by the mapper
L.something = "qualcosa"

-- Kill events
L.desc_event_kill_suicide = "E' stato un suicidio."
L.desc_event_kill_team = "E' stata ."
...
-- 2021-04-24
L.karma_teamkill_tooltip = "UccisioniAlleato"
L.karma_teamhurt_tooltip = "AlleatiDanneggiati"
L.karma_enemykill_tooltip = "NemiciUccisi"
L.karma_enemyhurt_tooltip = "NemiciDanneggiati"
L.karma_cleanround_tooltip = "RoundPulito"
L.karma_roundheal_tooltip = "Cureround"
L.karma_unknown_tooltip = "Sconosciuto"
